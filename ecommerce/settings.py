...
if env.str('ALLOWED_HOSTS', None):
    ALLOWED_HOSTS = [i for i in env.list('ALLOWED_HOSTS', None)] if env.list('ALLOWED_HOSTS', None) else ['*']
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Swagger Ecommerce APP',
    'VERSION': '1.0.0',
    'SERVE_INCLUDE_SCHEMA': False,
    # OTHER SETTINGS
    'CONTACT': {'name': 'Bhargav Sonagara', 'email': 'bhargavsonagara1776@gmail.com', },
